CREATE TABLE IF NOT EXISTS precinct_scores (
  ...
  comfort_label VARCHAR(20) NOT NULL CHECK (comfort_label IN ('Comfortable', 'Caution', 'High Risk')),
...
CREATE INDEX IF NOT EXISTS idx_precinct_scores_precinct_calc
  ON precinct_scores(precinct_id, calc_timestamp DESC);
