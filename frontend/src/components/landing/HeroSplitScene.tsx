...
function FlyingLoader() {
  return (
    <div className="landing-flying-loader" aria-hidden="true">
      <div className="landing-flying-loader-speed">
        <span>
          <span></span>
          <span></span>
          <span></span>
        ...
        <div className="landing-flying-loader-base">
          <span></span>
          <div className="landing-flying-loader-face"></div>
        </div>
      </div>
      <div className="landing-flying-loader-trails">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
...
function LoadingGlyphs() {
  return (
    <div className="landing-video-loader" aria-label="Loading hero video" role="status">
      <span className="l">
        ...
        >
          {shouldShowVideoPlaceholder ? (
            <div className="landing-video-placeholder">
              <div className="landing-video-loader-stack">
                <FlyingLoader />
                <LoadingGlyphs />
              </div>
            </div>
